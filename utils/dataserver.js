...
async function getAllData() {
    try {
        ...
        filteredDataByRealitationDate.forEach(e => {
            ...
            if(e.hasOwnProperty('whatsapp_ketua'))
            e.whatsapp_ketua = sanitizedNumber(e.whatsapp_ketua);
            if(e.hasOwnProperty('whatsapp_sekretaris'))
            e.whatsapp_sekretaris = sanitizedNumber(e.whatsapp_sekretaris);
            if(e.hasOwnProperty('whatsapp_bendahara'))
            e.whatsapp_bendahara = sanitizedNumber(e.whatsapp_bendahara);
        });
...
function getServedNotificationData(allData) {
    ...
    dispartedAT.forEach((element,index) => {
        if(element.hasOwnProperty('whatsapp_ketua')){
            let newObject = { 
                ...element,
                send_to:"ketua"
            }            
            newObject.hasOwnProperty('whatsapp_sekretaris')?delete newObject.whatsapp_sekretaris:null;
            newObject.hasOwnProperty('whatsapp_bendahara')?delete newObject.whatsapp_bendahara:null;
            dispartedContact.push(newObject);
        }
        if(element.hasOwnProperty('whatsapp_sekretaris')){
            let newObject = { 
                ...element,
                send_to:"sekretaris"
            }            
            newObject.hasOwnProperty('whatsapp_ketua')?delete newObject.whatsapp_ketua:null;
            newObject.hasOwnProperty('whatsapp_bendahara')?delete newObject.whatsapp_bendahara:null;
            dispartedContact.push(newObject);
        }
        if(element.hasOwnProperty('whatsapp_bendahara')){
            let newObject = { 
                ...element,
                send_to:"bendahara"
            }            
